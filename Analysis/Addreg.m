function varargout = Addreg(varargin)
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @Addreg_OpeningFcn, ...
                   'gui_OutputFcn',  @Addreg_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function Addreg_OpeningFcn(hObject, eventdata, handles, varargin)
handles.output = hObject;
guidata(hObject, handles);

function varargout = Addreg_OutputFcn(hObject, eventdata, handles) 
