function varargout = SkullStrip(varargin)
% SKULLSTRIP MATLAB code for SkullStrip.fig
% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @SkullStrip_OpeningFcn, ...
                   'gui_OutputFcn',  @SkullStrip_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before SkullStrip is made visible.
function SkullStrip_OpeningFcn(hObject, eventdata, handles, varargin)
handles.output = hObject;

guidata(hObject, handles);
function varargout = SkullStrip_OutputFcn(hObject, eventdata, handles) 
