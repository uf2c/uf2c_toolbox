function varargout = Volumetry(varargin)
% VOLUMETRY MATLAB code for Volumetry.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @Volumetry_OpeningFcn, ...
                   'gui_OutputFcn',  @Volumetry_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function Volumetry_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = Volumetry_OutputFcn(hObject, eventdata, handles) 
