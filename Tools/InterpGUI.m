function varargout = InterpGUI(varargin)
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @InterpGUI_OpeningFcn, ...
                   'gui_OutputFcn',  @InterpGUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function InterpGUI_OpeningFcn(hObject, eventdata, handles, varargin)
handles.output = hObject;
guidata(hObject, handles);

function varargout = InterpGUI_OutputFcn(hObject, eventdata, handles) 
