function varargout = uf2c_Maps_Intersection(varargin)

% Last Modified by GUIDE v2.5 30-Apr-2019 10:02:18

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @uf2c_Maps_Intersection_OpeningFcn, ...
                   'gui_OutputFcn',  @uf2c_Maps_Intersection_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function uf2c_Maps_Intersection_OpeningFcn(hObject, eventdata, handles, varargin)
handles.output = hObject;
guidata(hObject, handles);

function varargout = uf2c_Maps_Intersection_OutputFcn(hObject, eventdata, handles) 
